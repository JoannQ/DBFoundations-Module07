...
-- 2017-01-01,QJoann,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name
From SysDatabases
Where Name = 'Assignment07DB_QJoann')
	 Begin
	Alter Database [Assignment07DB_QJoann] set Single_user With Rollback Immediate;
	Drop Database Assignment07DB_QJoann;
End
	Create Database Assignment07DB_QJoann;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment07DB_QJoann;
...
SELECT * FROM vProductInventories -- Check that it works: Select * From vProductInventories;
go
...
-- <Put Your Code Here> --
Create or Alter View vProductInventoriesWithPreviouMonthCounts
AS
	SELECT Top 100000
	  ProductName
    , InventoryDate
	, [InventoryCount] = [Count]
	, [PreviousMonthCount]=IIF(DatePart(mm,InventoryDate)=1, 0, lag(Count) Over(ORDER BY ProductName,DatePart(mm,InventoryDate)))
...
-- <Put Your Code Here> --
Create Or Alter Function dbo.fProductInventoriesWithPreviousMonthCountsWithKPIs(@KPI int)
 Returns Table 
 AS 
   Return(
